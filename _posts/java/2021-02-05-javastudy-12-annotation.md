...
## 목차 
1. [어노테이션이란?](#0-열거형enum이란)
2. [표준 어노테이션의 종류](#1-열거형-정의와-사용법)
3. [메타 어노테이션](#2-javalangenum열거형의-조상)
4. [어노테이션 타입 정의방법](#3-enum에-멤버-추가하기)
5. [어노테이션 요소의 규칙](#4-enumset-열거셋)
